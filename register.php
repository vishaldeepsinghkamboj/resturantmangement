			...
			if($row['numrows'] > 0){
				...
				try{
				    ...
				    try {
				        ...
				        $mail->SMTPAuth = true;                               
				        $mail->Username = 'kambojdeepvishal@gmail.com';     
				        $mail->Password = 'vishaldeep2600';                    
				        ...
				        $mail->setFrom('kambojdeepvishal@gmail.com');
				        
				        //Recipients
				        $mail->addAddress($email);              
				        $mail->addReplyTo('kambojdeepvishal@gmail.com');
				       
				        //Content
				        $mail->isHTML(true);                                  
				        $mail->Subject = 'MultiCuisine';
				        $mail->Body    = $message;
